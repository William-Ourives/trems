...
6. Name the environment `trems-william-ourives.tangrama.com.br` and hit `Configure environment`.
...
|-------------|--------------|-------------|
| DEPLOY_HOST | trems-william-ourives.tangrama.com.br | The hostname or IP address of your Docker Swarm manager. |
...
| Name     | Value |
|----------|-------|
| LIVE_ENV | trems-william-ourives.tangrama.com.br |
...
- Initiate a new deployment using the `devops/stacks/trems-william-ourives.tangrama.com.br.yml` stack.
