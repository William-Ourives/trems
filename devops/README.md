...
```
DEPLOY_ENV=prod
DEPLOY_HOST=trems-william-ourives.tangrama.com.br
DEPLOY_PORT=22
DEPLOY_USER=plone
DOCKER_CONFIG=.docker
STACK_NAME=trems-william-ourives-tangrama-com-br
```
...
prod:
  hosts:
    trems-william-ourives.tangrama.com.br:
      ansible_user: root
      host: trems-william-ourives
      hostname: trems-william-ourives.tangrama.com.br
```
...
Deploy the stack defined in `devops/stacks/trems-william-ourives.tangrama.com.br.yml` to the remote server with:
